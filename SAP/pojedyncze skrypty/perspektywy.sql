...
select sum(cenacalkowita) as "Roczna Sprzeda¿" from rachunki where DATAZAKUPU > getdate() - 366;
create or replace view Polroczna_sprzedaz as
select sum(cenacalkowita) as "Polroczna Sprzeda¿" from rachunki where DATAZAKUPU > getdate() - 183;
create or replace view Kwartalna_sprzedaz as
select sum(cenacalkowita) as "Kwartalna Sprzeda¿" from rachunki where DATAZAKUPU > getdate() - 92;
create or replace view Miesieczna_sprzedaz as
select sum(cenacalkowita) as "Miesieczna Sprzeda¿" from rachunki where DATAZAKUPU > getdate() - 31;
...
and rachunki.DATAZAKUPU > getdate()-366;
...
from rachunek_poz, produkty, rachunki where produkty.IDPRODUKTU=rachunek_poz.IDPRODUKTU and rachunek_poz.IDRACHUNKU = rachunki.IDRACHUNKU
and rachunki.DATAZAKUPU > getdate()-183;
...
from rachunek_poz, produkty, rachunki where produkty.IDPRODUKTU=rachunek_poz.IDPRODUKTU and rachunek_poz.IDRACHUNKU = rachunki.IDRACHUNKU
and rachunki.DATAZAKUPU > getdate()-92;
...
from rachunek_poz, produkty, rachunki where produkty.IDPRODUKTU=rachunek_poz.IDPRODUKTU and rachunek_poz.IDRACHUNKU = rachunki.IDRACHUNKU
and rachunki.DATAZAKUPU > getdate()-31;
